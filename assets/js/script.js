...
var ingredientsTermInput = document.querySelector("#search-bar");
...
searchForm.addEventListener("submit", function (event) {
    ...
    fetch(urlToFetch)
        ...
        //how to display first 10 options and then link ID???
        .then(function (data) {
            console.log(data);
            ...
            fetch(urlToFetch2)
                ...
                .then(function (data) {
                    ...
                    var resultsContent = document.getElementById
                        ...
                        recipeTitleh2.textContent =data.title;
                        resultsContent.append("Recipe: ", recipeTitleh2)
                })
        })
})